...
public class Database extends SQLiteOpenHelper {
    ...
    public Cursor getCartData(String username, String otype) {
        String str[] = new String[2];
        str[0] = username;
        str[1] = otype;
        SQLiteDatabase db = getReadableDatabase();
        return db.rawQuery("select * from cart where username=? and otype=?", str);
    }
    ...
    public Cursor getAppointmentData(String username) {
        String str[] = new String[2];
        str[0] = username;
        str[1] = "appointment";
        SQLiteDatabase db = getReadableDatabase();
